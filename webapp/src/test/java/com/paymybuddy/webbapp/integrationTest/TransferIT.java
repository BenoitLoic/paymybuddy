...
import com.paymybuddy.webbapp.integrationTest.Repository.TransferRepo;
...
public class TransferIT {
  ...
  @Autowired TransferRepo transferRepo;
  ...
  public void getTransfers() throws Exception {
    ...
    mockMvc
        .perform(
            get(readTransferUrl).with(SecurityMockMvcRequestPostProcessors.user("frodo@mail.com")))
    ...
    mockMvc
        .perform(
            get(readTransferUrl).with(SecurityMockMvcRequestPostProcessors.user("smaug@mail.com")))
        .andExpect(status().isOk())
    ...
    mockMvc
        .perform(
            post(addMoneyUrl)
                ...
                .with(SecurityMockMvcRequestPostProcessors.user("sam@mail.com"))
  ...
  public void createTransfer() throws Exception {
    ...
    // When valid
    NewTransferDto transferDto1 = new NewTransferDto("sam@mail.com", 21.3, "bordures");
    ...
    NewTransferDto transferDto2 = new NewTransferDto("sam@mail.com", 9999999, "erreur");
