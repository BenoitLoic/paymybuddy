...
import com.paymybuddy.webapp.exception.DataNotFindException;
import com.paymybuddy.webapp.model.UserModel;
...
public class UserServiceImpl implements UserService {
  ...
  /**
   * This method save the given user in DB by calling Dao. this method is used to create a new user
  ...
  public Collection<ContactDto> getAllContact(String userEmail) {
    ...
    for (User contact : contactList) {
      ContactDto temp =
          new ContactDto(contact.getFirstName(), contact.getLastName(), contact.getEmail());
