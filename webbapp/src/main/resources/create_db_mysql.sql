...
-- -----------------------------------------------------
CREATE USER IF NOT EXISTS 'adm_pmb'@'localhost' IDENTIFIED BY 'adm_pmb';
GRANT ALL PRIVILEGES ON pay_my_buddy . * TO 'adm_pmb'@'localhost';
CREATE USER IF NOT EXISTS 'test_pmb'@'localhost' IDENTIFIED BY 'test_pmb';
GRANT ALL PRIVILEGES ON pay_my_buddy_test . * TO 'test_pmb'@'localhost';
FLUSH PRIVILEGES;